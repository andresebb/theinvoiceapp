          ...
          <div className="bill-to">
            ...
            <div className="block">
              ...
              <input
                ...
                defaultValue={actualInvoice.billToName}
              />
            </div>
            <div className="block">
              ...
              <input
                ...
                name="billToEmail"
                onChange={handleInputChange}
                defaultValue={actualInvoice.billToEmail}
              />
            </div>
            <div className="block">
              ...
              <input
                ...
                name="billToStreet"
                onChange={handleInputChange}
                defaultValue={actualInvoice.billToStreet}
              />
            </div>
            <div className="location block">
              <div className="location-container">
                ...
                <input
                  ...
                  name="billToCity"
                  onChange={handleInputChange}
                  defaultValue={actualInvoice.billToCity}
                />
              </div>
              <div className="location-container">
                ...
                <input
                  ...
                  name="billToCode"
                  onChange={handleInputChange}
                  defaultValue={actualInvoice.billToCode}
                />
              </div>
            </div>
            <div className="block">
              ...
              <input
                ...
                name="billToCountry"
                onChange={handleInputChange}
                defaultValue={actualInvoice.billToCountry}
              />
            </div>
            ...
            <div className="">
              ...
              <input
                ...
                onChange={handleInputChange}
                defaultValue={actualInvoice.billToDescription}
              />
            </div>
          </div>
        </>
